...
namespace Assets.Code
{
    public class SocType_ElectiveMonarchy : SocType
    {
        ...
        public override string getDesc()
        {
            ...
            + "\nThis society is an elective monarchy, that is to say that the nobles vote on their rulers, selecting a single noble to act as sovereign."
            + "\nIf the nation owns enough territory outside the sovereign's province, they will elect dukes to rule over provinces. If they do, the sovereign can only be elected from the dukes (or be re-elected)"
